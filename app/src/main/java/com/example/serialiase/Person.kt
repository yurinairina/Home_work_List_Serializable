...
//
//class Person (val name: String, val surname: String, val adress: String, val tele: String){
//
//        override fun toString(): String {
//            return "$name, $surname,$adress, + $tele"
//        }
//    }
//class InputPerson(private val context: Context, private val person: Person) {
